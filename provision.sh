...
apt-get update
apt-get install -y build-essential gdb ntp cloc jq unzip libjson-perl vim emacs tmux tmate git locate curl cpanminus exuberant-ctags vim-nox htop iotop atop sysdig ack-grep graphviz linux-tools etckeeper python-requests
